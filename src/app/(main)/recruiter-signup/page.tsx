...
export default function RecruiterSignup(){
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                router.push(`/verify-recruiter-signup-otp?${queryParams.toString()}`);
            } else {
    ...
    if (success) {
        return (
            <>
                <Navbar />
                <section className="bg-home d-flex align-items-center justify-content-center" style={{backgroundImage:"url('/images/hero/bg3.jpg')", backgroundPosition:'center', marginTop: '76px'}}>
                    <div className="bg-overlay bg-linear-gradient-2"></div>
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-lg-5 col-md-6 col-12">
                                <div className="p-4 bg-white rounded shadow-md mx-auto w-100 text-center" style={{maxWidth:'450px'}}>
                                    <Link href="/"><Image src="/images/IGL_Group_logo.png" width={58} height={58} className="mb-4 d-block mx-auto" alt=""/></Link>
                                    <div className="alert alert-success mb-0" role="alert">
                                        <strong>Success!</strong> Recruiter account created successfully. 
    ...
    return(
        <>
            <Navbar />
            <section className="bg-home d-flex align-items-center justify-content-center" style={{backgroundImage:"url('/images/hero/bg3.jpg')", backgroundPosition:'center', marginTop: '76px', minHeight: '100vh'}}>
                <div className="bg-overlay bg-linear-gradient-2"></div>
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-5 col-md-6 col-12">
                            <div className="p-4 bg-white rounded shadow-md mx-auto w-100" style={{maxWidth:'450px'}}>
                                <form onSubmit={handleSubmit}>
                                    <Link href="/"><Image src="/images/IGL_Group_logo.png" width={58} height={58} className="mb-4 d-block mx-auto" alt=""/></Link>
                                    <h6 className="mb-3 text-uppercase fw-semibold">Create Recruiter Account</h6>
                                    ...
                                    <div className="mb-3">
                                        <div className="form-check">
                                            ...
                                            <label className="form-check-label text-muted" htmlFor="agreeTerms">
                                                I agree to the <Link href="/terms" className="text-primary">Terms and Conditions</Link> and <Link href="/privacy" className="text-primary">Privacy Policy</Link> <span className="text-danger">*</span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-12 text-center mt-3">
                                        <span>
                                            ...
                                            <Link href="/login" className="text-dark fw-semibold small">Sign in here</Link>
                                        </span>
                                    </div>

                                    <div className="col-12 text-center mt-2">
                                        <span>
                                            <span className="text-muted small me-2">Looking for job seeker account?</span> 
                                            <Link href="/signup" className="text-dark fw-semibold small">Sign up as Job Seeker</Link>
                                        </span>
                                    </div>
                                </form>
                            </div>
