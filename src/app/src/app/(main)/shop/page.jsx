              ...
              <div className="breadcrumb-product text-center">
                <div className="thumb">
                  <Link href="/pro/hello-product">
                    <img
                      src="/assets/client_assests/img/product/br_product_img.png"
                      alt="img"
                    />
                  </Link>
                  <span>35% OFF</span>
                    ...
                    <ul>
                      <li>
                        <div className="thumb">
                          <Link href="/pro/hello-product">
                            <img
                              src="/assets/client_assests/img/product/sidebar_product01.jpg"
                              alt="img"
                            />
                          </Link>
                        </div>
                      ...
                      <li>
                        <div className="thumb">
                          <Link href="/pro/hello-product">
                            <img
                              src="/assets/client_assests/img/product/sidebar_product02.jpg"
                              alt="img"
                            />
                          </Link>
                        </div>
                      ...
                      <li>
                        <div className="thumb">
                          <Link href="/pro/hello-product">
                            <img
                              src="/assets/client_assests/img/product/sidebar_product03.jpg"
                              alt="img"
                            />
                          </Link>
                        </div>
                  ...
                  >
                    <div className="shop-product-item mb-30">
                      <div className="shop-thumb">
                        <Link href={`/pro/${product.id}/${product.pro_slug}`}>
                          <img
                            src={`${process.env.NEXT_PUBLIC_SERVER_URL}/uploads/products/${product.pro_thumbnail}`}
                            alt={product.pro_title}
                          />
                        </Link>
                        {product.pro_has_discount && (
                      ...
                      <div className="shop-content">
                        <ul className="tag">
                          <li>
                            Sold by
                            <Link href={`/vendor/${product.pro_vendor_id}`}>
                              {product.pro_vendor_id} Store
                            </Link>
                          </li>
                        </ul>
                        <h2 className="title">
                          <Link href={`/pro/${product.pro_slug}`}>
                            {product.pro_title}
                          </Link>
                        </h2>
                        <div className="rating">
                        ...
                        <div className="content-bottom">
                          <h4 className="price">
                            $
                            {(
                              product.pro_price - (product.pro_discount || 0)
                            ).toFixed(2)}
                            {product.pro_has_discount && (
