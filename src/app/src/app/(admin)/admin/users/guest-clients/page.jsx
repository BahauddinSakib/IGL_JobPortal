                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-4 mb-24px">
                            <div class="ec-user-card card card-default p-4">
                                ...
                                <a href="javascript:0" class="media text-secondary">
                                    <img src="assets/img/user/u-xl-4.jpg" class="mr-3 img-fluid" alt="Avatar Image"/>
                        ...
                        <div class="col-lg-6 col-xl-4 mb-24px">
                            <div class="ec-user-card card card-default p-4">
                                ...
                                <a href="javascript:0" class="media text-secondary">
                                    <img src="assets/img/user/u-xl-5.jpg" class="mr-3 img-fluid" alt="Avatar Image"/>
                        ...
                        <div class="col-lg-6 col-xl-4 mb-24px">
                            <div class="ec-user-card card card-default p-4">
                                ...
                                <a href="javascript:0" class="media text-secondary">
                                    <img src="assets/img/user/u-xl-6.jpg" class="mr-3 img-fluid" alt="Avatar Image"/>
                                    <div class="media-body">
                        ...
                        <div class="col-lg-6 col-xl-4 mb-24px">
                            <div class="ec-user-card card card-default p-4">
                                ...
                                <a href="javascript:0" class="media text-secondary">
                                    <img src="assets/img/user/u-xl-7.jpg" class="mr-3 img-fluid" alt="Avatar Image"/>
                        ...
                        <div class="col-lg-6 col-xl-4 mb-24px">
                            <div class="ec-user-card card card-default p-4">
                                ...
                                <a href="javascript:0" class="media text-secondary">
                                    <img src="assets/img/user/u-xl-8.jpg" class="mr-3 img-fluid" alt="Avatar Image"/>
                        ...
                        <div class="col-lg-6 col-xl-4 mb-24px">
                            <div class="ec-user-card card card-default p-4">
                                ...
                                <a href="javascript:0" class="media text-secondary">
                                    <img src="assets/img/user/u-xl-9.jpg" class="mr-3 img-fluid" alt="Avatar Image"/>
                        ...
                        <div class="col-lg-6 col-xl-4 mb-24px">
                            <div class="ec-user-card card card-default p-4">
                                ...
                                <a href="javascript:0" class="media text-secondary">
                                    <img src="assets/img/user/u-xl-10.jpg" class="mr-3 img-fluid" alt="Avatar Image"/>
                                    <div class="media-body">
                        ...
                        <div class="col-lg-6 col-xl-4 mb-24px">
                            <div class="ec-user-card card card-default p-4">
                                ...
                                <a href="javascript:0" class="media text-secondary">
                                    <img src="assets/img/user/u-xl-11.jpg" class="mr-3 img-fluid" alt="Avatar Image"/>
                                    <div class="media-body">
                        ...
                        <div class="col-lg-6 col-xl-4 mb-24px">
                            <div class="ec-user-card card card-default p-4">
                                ...
                                <a href="javascript:0" class="media text-secondary">
                                    <img src="assets/img/user/u-xl-12.jpg" class="mr-3 img-fluid" alt="Avatar Image"/>
                                ...
                                <form>
                                    ...
                                    <div class="modal-body px-4">
                                        <div class="form-group row mb-6">
                                            <label htmlFor="coverImage" class="col-sm-4 col-lg-2 col-form-label">User
                                                Image</label>
                                            ...
                                            <div class="col-sm-8 col-lg-10">
                                                <div class="custom-file mb-1">
                                                    <input type="file" class="custom-file-input" id="coverImage"
                                                        required/>
                                                    <label class="custom-file-label" htmlFor="coverImage">Choose
                                                        file...</label>
