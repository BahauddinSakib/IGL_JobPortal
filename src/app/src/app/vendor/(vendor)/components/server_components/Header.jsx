  ...
  return (
    ...
    >
      <div className="ec-brand" style={{ background: "white" }}>
        <Link href="/vendor" title="SmartDsm">
          <img
            className="ec-brand-icon"
            src="../assets/admin_assets/img/logo/ec-site-logo.png"
            alt=""
          />
          <span className="ec-brand-name text-truncate">SmartDsm</span>
        </Link>
      </div>
