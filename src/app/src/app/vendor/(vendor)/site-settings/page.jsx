                            ...
                            <div className="avatar-preview ec-preview">
                              <div className="imagePreview ec-div-preview">
                                <img
                                  ...
                                  src={`${process.env.imageBaseurl}/uploads/site-data/${existingSiteData.logoPreview}`}
                                  alt="logo preview"
                                />
                              </div>
                            </div>
                          ...
                          <div className="avatar-upload">
                            ...
                            <div className="avatar-preview ec-preview">
                              <div className="imagePreview ec-div-preview">
                                <img
                                  className="ec-image-preview"
                                  src={`${process.env.imageBaseurl}/uploads/site-data/${existingSiteData.bannerPreview}`}
                                  alt="banner preview"
                                />
                              </div>
                            </div>
